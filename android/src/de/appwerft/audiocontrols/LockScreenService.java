...
public class LockScreenService extends Service {
	...
	public void onCreate() {
		...
		int layoutId = context.getResources().getIdentifier(
				"remoteaudiocontroler", "layout", pn);
		...
		Button rewindButton = (Button) inflater.inflate(
				rewindcontrolId = res.getIdentifier("rewindcontrol", "layout",
						pn), null);
		Button forwardButton = (Button) inflater.inflate(
				forwardcontrolId = res.getIdentifier("rewindcontrol", "layout",
						pn), null);
		Button playButton = (Button) inflater.inflate(
				playcontrolId = res.getIdentifier("playcontrol", "layout", pn),
				null);
